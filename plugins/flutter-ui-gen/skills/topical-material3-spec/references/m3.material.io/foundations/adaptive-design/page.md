...
![A spatial UI in XR, with a navigation rail orbiter to the left of an email inbox.](assets/asset-001-device-conditions-include-full-screen-windowed-and-spatialized-8eacb1148f.png)

*Device conditions include full-screen, windowed, and spatialized environments, as well as device states like posture*

![App window being resized horizontally.](assets/asset-002-window-size-conditions-include-window-size-classes-and-e620e387ae.png)

*Window size conditions include window size classes and orientation*

![Hand cursor hovering over a card.](assets/asset-003-input-modality-conditions-include-methods-like-touch-stylus-5be0ae3889.png)
...
![App screen presented on mobile, foldable, and tablet.](assets/asset-004-like-the-panes-of-glass-that-make-up-9d5f3a508b.png)
...
![A card with a button that spans the full width, and a card with a button that’s left-aligned and hugs its contents.](assets/asset-005-buttons-can-hug-their-contents-or-span-their-518936d035.png)
...
![A list on mobile and on tablet. List items show additional text on tablet.](assets/asset-006-list-items-can-reveal-more-text-on-a-7d185ab6e0.png)
...
![Extended FAB changing to standard FAB when an app window is made smaller.](assets/asset-007-the-extended-fab-can-change-to-a-standard-5cba3763f9.png)
