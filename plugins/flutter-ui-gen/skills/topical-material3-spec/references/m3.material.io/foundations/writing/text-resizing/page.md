...
![Padding is the same on the top and bottom edges of the buttons.](assets/asset-001-button-text-displayed-at-1x-1-3x-and-651180da8f.webp)

*Button text displayed at 1x, 1.3x, and 2x scales. All have top and bottom padding of 8dp.*

![Button text displayed at 1x, 1.3x, and 2x scales. All have left and right padding of 24dp.](assets/asset-002-left-and-right-padding-remains-constant-at-24dp-df84c6e718.webp)
...
![Button with label text at 1x and 2x scale.](assets/asset-003-for-example-if-a-font-is-14pt-at-4f9398589e.webp)
...
![Icon button with the icon shown at 1x scale and incorrectly at 2x scale.](assets/asset-004-don-t-when-designing-for-text-resizing-don-9505851595.webp)

*Don’t When designing for text resizing, don't resize components without text*

![Menu with labels at 1x scale.](assets/asset-005-ui-text-displayed-at-1x-efe89f53b6.webp)

*UI text displayed at 1x*

![Menu with labels at 2x scale.](assets/asset-006-ui-text-displayed-at-2x-in-which-only-3efbcc9a1f.webp)
...
![Menu with labels at 2x scale.](assets/asset-007-text-that-is-too-small-and-dense-can-628d410356.webp)

*Text that is too small and dense can appear overwhelming and difficult to read*

![Menu with labels at 1x scale.](assets/asset-008-larger-text-can-help-people-focus-on-one-c475970547.webp)
...
![Side by side of 4 commonly found issues when resizing text up.](assets/asset-009-unresponsive-container-unintentionally-clipped-text-unresponsive-text-overlapping-ec47933bfe.webp)
...
![left: buttons placed side-by-side. Right: buttons stacked on top of one another.](assets/asset-010-ui-displayed-at-1x-buttons-positioned-side-by-dcf1a2f001.webp)
...
![Dialog with a lot of text at 2x size. The text is cut off but accessible when scrolling.](assets/asset-011-some-screens-may-not-be-able-to-resize-d07b63d493.webp)
...
![Tooltip on navigation rail displays scaled up label text.](assets/asset-012-do-scale-up-text-in-an-adjacent-tooltip-6c45513d63.webp)
