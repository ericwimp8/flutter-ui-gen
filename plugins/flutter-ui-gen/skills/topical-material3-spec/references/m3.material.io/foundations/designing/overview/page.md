...
![Diagram of switches showing the Tab key changing the focus to the second switch and Space/Enter corresponding to changing the state of the switch.](assets/asset-001-1-switch-in-the-on-state-with-visible-90d5cb236d.webp)

*1. Switch in the on state with visible focus 2. Switch in the off state with visible focus*
...
![A dialog in a UI screen requesting user confirmation to discard calendar event](assets/asset-002-do-use-native-elements-such-as-the-standard-674e9c0560.webp)

*Do Use native elements, such as the standard platform dialog*

![A banner requesting user confirmation to discard a calendar event](assets/asset-003-don-t-be-wary-of-using-non-standard-53379e8933.webp)
