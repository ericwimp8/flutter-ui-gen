...
![Navigation and body regions shown on 3 different screen types.](assets/asset-001-navigation-body-068b78a03f.webp)
...
![Side-by-side windows with single taskbar below.](assets/asset-002-two-windows-shown-next-to-one-another-with-312b45a121.webp)
...
![Navigation drawer, navigation rail, and navigation bar each shown on a separate screen.](assets/asset-003-three-different-navigation-components-suit-a-variety-of-13893bc459.webp)
...
![Body region highlighted on a mobile screen.](assets/asset-004-the-body-region-is-the-area-outside-of-c955b8e35c.webp)
...
![Two paned screen layout.](assets/asset-005-first-pane-second-pane-95983fb318.webp)
...
![Fixed and flexible panes of a screen.](assets/asset-006-fixed-pane-flexible-pane-4762174c38.webp)
...
![Two-pane layout on a tablet](assets/asset-010-implicit-grouping-can-be-used-to-create-hierarchy-013d7afe97.webp)
...
![Two-pane layout in a spatialized environment, with no background.](assets/asset-011-explicit-containment-is-recommended-in-xr-70732448e8.webp)
...
![Screen layout with app bar inside left pane.](assets/asset-012-app-bars-are-placed-inside-panes-c4fb9c7113.webp)
...
![Top app bar of a compact window on a mobile device shows 2 items.](assets/asset-013-a-compact-window-with-two-actions-revealed-9d7a930fba.webp)

*A compact window with two actions revealed*

![Top app bar of expanded window shows 5 items.](assets/asset-014-an-expanded-window-class-with-five-items-revealed-7e97f93a3a.webp)
...
![Email preview erroneously shifted to left-hand pane.](assets/asset-015-don-t-move-elements-to-different-ui-objects-5f9365cefb.webp)
...
![A single pane containing 3 columns.](assets/asset-016-using-one-pane-an-app-like-news-uses-0112d7c1f0.webp)
...
![Mobile phone with two panes stacked vertically and a drag handle in between.](assets/asset-018-drag-handles-can-be-used-vertically-6bdb7d7e1c.webp)
...
![Drag handle centered in the spacer between panes.](assets/asset-020-pane-drag-handle-between-two-panes-e8246011a4.webp)
...
![Drag handle on the inside of a collapsed pane.](assets/asset-021-pane-drag-handle-on-the-left-edge-of-60c0fb5d55.webp)
...
![The drag handle touch target area covers part of the back gesture touch target area.](assets/asset-022-the-pane-drag-handle-ui-overrides-the-back-d99eaaea9a.webp)
...
![A list-detail layout with no items selected, and no drag handle visible.](assets/asset-023-a-list-detail-layout-doesn-t-need-a-5ca9f1e201.webp)
...
![A list-detail layout for a chat app with a button for expanding the chat pane to a single-pane layout.](assets/asset-024-a-layout-toggle-button-could-be-used-if-1e504872a3.webp)
...
![Drag handle annotated with "Role = button."](assets/asset-025-the-drag-handle-should-behave-like-a-button-c1b274394b.webp)
