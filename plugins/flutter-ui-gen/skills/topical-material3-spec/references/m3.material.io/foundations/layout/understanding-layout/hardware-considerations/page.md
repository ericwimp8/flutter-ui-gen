...
![Content safe area shown in portrait and in landscape mode.](assets/asset-001-a-mobile-device-s-content-safe-area-around-2906faa57e.webp)
...
![Center fold of a foldable device layout.](assets/asset-002-folds-are-typically-found-in-the-center-of-7aa303dfd6.webp)
...
![Center fold on a foldable device with a physical hinge.](assets/asset-003-a-physical-hinge-separates-two-parts-there-is-2e90ec4adf.webp)
...
![Compact window of a folded device.](assets/asset-004-the-front-screen-of-a-foldable-device-0be7221ece.webp)
...
![Open portrait state of a mobile device.](assets/asset-005-in-an-open-portrait-state-the-longer-device-27a22e4d0e.webp)

*In an open portrait state, the longer device edge is vertical while the shorter edge is horizontal*

![Open landscape state of a mobile device.](assets/asset-006-in-an-open-landscape-state-the-longer-device-91bb6ab18d.webp)
...
![Tabletop state of a mobile device showing camera;ems on the vertical plane.](assets/asset-007-if-camera-hardware-is-present-a-tabletop-device-40b313f3ef.webp)
...
![A news app in compact mode compared to the open landscape state where the news app expands with a new column next to the compact news feed.](assets/asset-008-a-news-app-shows-a-feed-in-a-b49950eead.webp)
...
![A foldable device screen in open landscape mode with a single pane showing vertical scroll arrows.](assets/asset-009-a-single-pane-can-scroll-its-inside-content-33ea1aea65.webp)
...
![A foldable device screen in open portrait mode with double panes each with a vertical scroll arrow.](assets/asset-010-multiple-panes-can-scroll-inside-content-independently-of-5d4ec24b16.webp)
...
![2 apps appear side-by-side with a task bar below spanning the width of the screen.](assets/asset-011-screen-displaying-an-email-app-and-a-contacts-114fbb0f46.webp)
...
![The taskbar is positioned at the bottom of a screen.](assets/asset-012-android-taskbar-5faf9c5045.webp)
...
![2 apps appear side-by-side with a task bar below spanning the width of the screen.](assets/asset-013-multi-window-mode-can-have-vertical-positioning-840c78ce79.webp)

*Multi-window mode can have vertical positioning*

![2 apps are stacked in landscape mode with a task bar below spanning the width of the screen.](assets/asset-014-multi-window-mode-can-have-horizontal-positioning-70842018d4.webp)
...
![2 apps appear side-by-side with the left-side app using two-thirds of the screen, and the right app one-third.](assets/asset-015-the-screen-handle-can-be-dragged-and-released-71d9f7d539.webp)
