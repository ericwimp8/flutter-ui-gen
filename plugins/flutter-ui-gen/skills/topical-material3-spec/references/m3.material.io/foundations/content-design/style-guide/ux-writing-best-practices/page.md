...
!["Move to trash?" dialog with the message "Big birthday bash will be deleted after 30 days."](assets/asset-001-do-tell-users-what-will-happen-if-they-537c3b770c.webp)

*Do Tell users what will happen if they take an action and how they can undo it*

!["Are you sure you want to move to trash?"dialog with the message "You'll be able to find "Big birthday bash" in your trash for 30 days."](assets/asset-002-don-t-misrepresent-consequences-or-try-to-influence-411aae1769.webp)
...
![Easily scannable content with different headings and subheadings on a card.](assets/asset-003-use-headings-and-subheads-to-prioritize-and-group-a3816fa1c3.webp)
...
![Sentence-style capitalization used for the title and consequence statement in a dialog.](assets/asset-004-do-capitalize-the-first-word-of-a-sentence-105de4c924.webp)

*Do Capitalize the first word of a sentence or phrase*

![Title casing used for the title in a dialog.](assets/asset-005-don-t-use-title-case-capitalization-instead-use-8731ac7958.webp)
...
![AM and PM abbreviations used on a clock app.](assets/asset-006-do-when-an-abbreviation-is-appropriate-make-sure-82e1748fa4.webp)

*Do When an abbreviation is appropriate, make sure it’s formatted and spelled correctly to avoid confusion*

![Abbreviations used for months and days on buttons when there is enough space to spell them out.](assets/asset-007-don-t-avoid-using-abbreviations-when-there-s-ed7dcfe520.webp)
