...
![Empty wishlist screen that references the holidays](assets/asset-001-do-use-generalized-global-examples-most-countries-and-8052a6847e.webp)

*Do Use generalized, global examples. Most countries and cultures have holidays.*

![Empty wishlist screen that references Christmas](assets/asset-002-don-t-call-out-a-specific-country-or-56b509ee81.webp)
...
![Empty state that references New York with message description about replacing New York with a well-known city in other languages](assets/asset-003-caution-help-translators-understand-the-context-by-adding-8b9957ffad.webp)
...
![2 screens side by side, in English and German](assets/asset-004-many-languages-like-german-are-longer-than-english-472109ec90.webp)
...
![Dialog with options that aren’t abbreviated](assets/asset-005-do-use-clear-names-to-refer-to-things-941d42affd.webp)

*Do Use clear names to refer to things*

![Dialog with options that are abbreviated](assets/asset-006-caution-avoid-abbreviations-if-they-re-used-provide-14662bbfc5.webp)
...
![Photo app with snackbar that reads “Couldn’t move photo”](assets/asset-007-do-using-nouns-instead-of-or-in-addition-bdf07ccd88.webp)

*Do Using nouns instead of, or in addition to, pronouns can help clarify future and past user actions*

![Photo app with snackbar that reads “Couldn’t move it to ‘Travel’ folder because it’s unavailable”](assets/asset-008-don-t-avoid-using-pronouns-when-it-s-8927b4c42b.webp)
...
![Form with clear writing that doesn’t use “this” or “that”](assets/asset-009-do-make-sure-it-s-clear-who-text-c6421b60ba.webp)

*Do Make sure it’s clear who text is referring to*

![Form with a subhead that reads “This can be seen by your IT administrator.” It’s not clear what “this” refers to.](assets/asset-010-don-t-avoid-using-this-and-that-c53e266a56.webp)
...
![Empty state with illustration that reads “Let’s go”](assets/asset-011-do-clear-everyday-language-can-be-used-in-c7c9c32489.webp)

*Do Clear, everyday language can be used in an expressive and whimsical way when paired with imagery*

![Empty state with illustration that reads “Let’s get this party started”](assets/asset-012-don-t-idiomatic-phrases-can-be-difficult-for-fc7b6d894f.webp)
...
![Dialog that prompts people to sign up to try new products](assets/asset-013-do-plain-language-is-easier-for-everyone-to-d819c24afc.webp)

*Do Plain language is easier for everyone to understand*

![Wordy and confusing dialog that prompts people to sign up for new communication preferences](assets/asset-014-don-t-confusing-language-makes-it-difficult-for-5c375d388b.webp)
...
![Screen displaying devices and speakers at home, next to bottom app bar with “home” button](assets/asset-015-clarify-words-that-have-multiple-meanings-home-could-b22eaa49d4.webp)
