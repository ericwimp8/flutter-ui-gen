...
Want to further adjust your brand color scheme? Check out [Advanced customizations](https://m3.material.io/m3/pages/advanced/overview)
...
5. Select the brand color role that most closely matches the use case and intent (see [Color roles](https://m3.material.io/m3/pages/color-roles) for more information on what color to use where).
...
5. Select the brand color role that most closely matches that color's use case (see [Color roles](https://m3.material.io/m3/pages/color-roles) for more information on what color to use where) and select Use style to apply it to the selected objects.
