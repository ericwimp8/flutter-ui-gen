...
![Examples of outlined symbols with stroke and fill attributes.](assets/asset-001-outlined-style-17437ce652.webp)

*Outlined style*

![Outlined icon set on grid.](assets/asset-002-2dp-outlined-icons-remain-readable-across-sizes-and-c4ea0371e9.webp)

*2dp outlined icons remain readable across sizes and applications*

![Four filled symbols showing full body human and proprietary icons.](assets/asset-003-for-optimal-legibility-and-recognition-some-symbols-should-ea36aff253.webp)
...
![Thin-lined outlined symbols correspond to app typography.](assets/asset-004-the-lighter-stroke-weight-of-these-outlined-symbols-daf3f1ff75.webp)
...
![Examples of rounded-style icons.](assets/asset-005-rounded-style-icons-f3158c39ef.webp)

*Rounded-style icons*

![Examples of sharp-style icons.](assets/asset-006-sharp-style-icons-c6959b4983.webp)

*Sharp-style icons*

![Plus icon as a round icon.](assets/asset-007-corner-radii-for-round-icons-146e3e8459.webp)

*Corner radii for round icons*

![Plus icon as a sharp icon.](assets/asset-008-square-corner-radii-for-sharp-icons-2c0f614991.webp)

*Square corner radii for sharp icons*

![Travel app with rounded buttons and rounded icons.](assets/asset-009-this-app-uses-rounded-buttons-and-round-icons-bbcc6d01b7.webp)

*This app uses rounded buttons and round icons*

![Six icons implementing sharp style.](assets/asset-010-the-0dp-corner-radius-of-the-sharp-icon-7e495b4ba7.webp)
...
![400 regular-weight icons used in standard navigation drawer and modal navigation drawer.](assets/asset-012-400-regular-weight-symbols-7577d3ee72.webp)

*400 regular-weight symbols*

![Photo gallery using 100 weight icons.](assets/asset-013-don-t-don-t-use-the-lightest-weight-135d14b1c9.webp)

*Don’t Don't use the lightest weight for standard-size (24dp) icons. The minimum weight for this size should be 200.*

![Three side-by-side 24p standard symbols.](assets/asset-014-caution-be-careful-using-excessive-weight-for-standard-6bdc65fdac.webp)

*Caution Be careful using excessive weight for standard 24dp symbols*

![Navigation rail with consistent symbol weights.](assets/asset-015-do-apply-weights-consistently-e8e993aaa8.webp)

*Do Apply weights consistently*

![Navigation rail with varying symbol weights.](assets/asset-016-don-t-mix-different-weights-b65d431913.webp)
...
![Unfilled icons.](assets/asset-017-unfilled-symbols-with-fill-set-to-0-1f1c1ed054.webp)

*Unfilled symbols with fill set to 0*

![Set of filled icons.](assets/asset-018-filled-symbols-with-fill-set-to-1-cb5ca0e12d.webp)
...
![Symbol thickness at grade 0 and at negative grade.](assets/asset-019-at-grade-0-the-thickness-of-the-symbol-e5c4bc6915.webp)
...
![Button with icon and text in light UI.](assets/asset-020-icon-button-featuring-a-0-default-grade-symbol-7bebfd4da0.webp)

*Icon button featuring a 0 default grade symbol in light UI*

![Button with icon and text in dark UI.](assets/asset-021-icon-button-featuring-a-negative-grade-symbol-in-00b381df70.webp)
...
![Photo icon in active state appearing bolder.](assets/asset-022-an-icon-with-active-state-using-positive-value-7e0a5521c4.webp)
...
![Four icons gradually increasing in optical size.](assets/asset-023-four-optical-sizes-20dp-24dp-40dp-48dp-ddebcc61a6.webp)
...
![Desktop dropdown menu with icon in active state.](assets/asset-025-use-20dp-optical-size-value-for-dense-layouts-7e864d4154.webp)

*Use 20dp optical size value for dense layouts on desktop*

![Forward and reverse symbols highlighted on device.](assets/asset-026-use-larger-size-40dp-48dp-symbols-when-primary-74e294f54d.webp)
...
![Selections of icons and typography examples in different contexts where weights and sizes are paired.](assets/asset-027-match-the-optical-weight-and-size-of-text-8522eedaad.webp)

*Match the optical weight and size of text and icon to ensure consistency*

![Text and icon that are the same size.](assets/asset-028-do-use-the-same-size-for-your-material-cffe58d283.webp)

*Do Use the same size for your Material Symbols and text*

![A small icon mismatched with larger text.](assets/asset-029-don-t-mix-the-sizes-of-your-symbol-695ca929b4.webp)

*Don’t mix the sizes of your symbol and text*

![An icon and text that are the same optical weight.](assets/asset-030-do-use-the-same-optical-weight-for-your-c6c4c4565e.webp)

*Do Use the same optical weight for your symbol and text*

![An icon and text that have mismatched optical weight.](assets/asset-031-don-t-use-different-optical-weights-for-material-2cf4895348.webp)

*Don’t use different optical weights for Material Symbols and text*

![Icon that has had its baseline shifted down 11.5%.](assets/asset-032-do-shift-down-the-baseline-of-symbols-to-42e626c370.webp)

*Do Shift down the baseline of symbols to approximately 11.5% of the text size*

![Icon and text that are using the same baseline.](assets/asset-033-don-t-use-the-same-baseline-for-material-4bdc3a6c8d.webp)
...
![Navigation bar showing four destinations, with 1 active destination featuring both icon and text label.](assets/asset-034-label-text-provides-short-descriptions-especially-useful-for-0fe3ce111f.webp)

*Label text provides short descriptions, especially useful for navigation*

![Navigation bar with four destinations with only icons, no labels.](assets/asset-035-use-caution-if-icons-are-displayed-without-labels-3d9e73e80d.webp)
...
![1. 24dp add symbol inside 48dp red square, 2. mobile UI with attach, add, and more symbols.](assets/asset-036-measurements-placement-af15fa51ae.webp)
...
![1. 24dp add symbol inside 48dp red square, 2. desktop UI with attach, add, and more symbols.](assets/asset-037-measurements-placement-595f28340a.webp)
...
![Comparison of three UIs showing add to cart, add to bag, and add to basket.](assets/asset-038-translate-icons-for-local-markets-for-example-different-a8585d8065.webp)
...
![Comparison of UIs where red and green are warning colors.](assets/asset-039-think-about-how-color-translates-some-locales-use-3c24ecd979.webp)
