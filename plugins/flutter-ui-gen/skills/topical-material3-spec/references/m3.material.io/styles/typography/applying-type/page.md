...
![Example display typeface.](assets/asset-001-an-expressive-typeface-can-be-used-for-display-e817c1d0bb.png)

*An expressive typeface can be used for display styles, as shown here with Bagel Fat One*

![Card featuring display size font.](assets/asset-002-a-card-using-a-display-size-7946ea64ad.png)

*A card using a display size*

![Large expressive typeface set above text.](assets/asset-003-an-expressive-typeface-can-entice-readers-to-engage-68a081557f.png)
...
![Example expressive headline typeface on phone screen.](assets/asset-004-expressive-typefaces-can-be-used-for-headlines-styles-c0c6b439e8.png)

*Expressive typefaces can be used for headlines styles as well, as shown here with Anton*

![The name Ana Russo in headline style in a contact card.](assets/asset-005-headline-style-used-for-short-text-on-a-abbed368b9.png)

*Headline style used for short text on a small screen*

![Headline style set above body text.](assets/asset-006-dialog-using-a-headline-style-88f895fe33.png)
...
![An article card using title style for the article title.](assets/asset-007-a-news-article-title-using-the-title-style-d28a050e03.png)

*A news article title using the title style to capture attention, as shown here with Bebas Neue*

![Top app bar using title style for the contact name, Aki Aro.](assets/asset-008-app-bar-using-title-style-9a72507bb3.png)

*App bar using title style*

![Title style stating ‘Top News’ above headlines.](assets/asset-009-example-of-title-style-applied-to-a-category-a185370327.png)
...
![Body-style typeface.](assets/asset-010-body-styles-must-be-readable-for-long-passages-555614ee64.png)

*Body styles must be readable for long passages*

![Body style text in article.](assets/asset-011-body-style-used-throughout-an-article-about-pesto-7084d25f72.png)

*Body style used throughout an article about pesto*

![Three stacked examples of body style in app setup flow.](assets/asset-012-example-of-body-style-used-throughout-a-setup-fbeace4f4b.png)
...
![Several label-style buttons on compact window.](assets/asset-013-label-styles-should-enable-quick-reading-at-small-d191b3b3c7.png)

*Label styles should enable quick reading at small sizes, such as in buttons*

![Music player timecode featuring label style.](assets/asset-014-a-music-player-using-label-style-for-the-15a1be5fdd.png)

*A music player using label style for the timecode*

![Five labels set horizontally across the navigation bar.](assets/asset-015-a-navigation-bar-using-label-style-for-the-b8007c2bb3.png)
...
![Diagram of bounding box equaling line height.](assets/asset-016-the-bounding-box-height-is-defined-by-the-5447b80e2e.png)
...
![Diagram of 20 dp padding above text.](assets/asset-017-the-padding-surrounding-the-text-bounding-box-9224d5ece8.png)
...
![Measurements of label text padding.](assets/asset-018-do-use-line-height-padding-and-container-measurements-971dd5807e.png)
...
![Diagram of using padding and bounding boxes to measure line height, alignment, and spacing,](assets/asset-019-diagram-of-using-padding-and-bounding-boxes-to-881c5475a9.png)
...
![Diagram indicating the baseline of text.](assets/asset-020-a-line-of-text-rests-on-the-invisible-0f6b11d549.png)
...
![Diagram of the distances between overline and container edge, plus subhead, overline, and caption text.](assets/asset-021-do-android-screens-rely-on-distance-to-baselines-a54a44109c.png)
...
![Diagram of using distance to baseline to measure line height, alignment, and spacing.](assets/asset-022-diagram-of-using-distance-to-baseline-to-measure-b32c6147e1.png)
...
![An example of larger type with a line height ratio of 1.2](assets/asset-023-for-larger-type-legibility-using-styles-like-title-e7103d60b5.png)
...
![An example of body type with a line height ratio of 1.5.](assets/asset-024-for-smaller-body-copy-using-styles-like-body-a1e2f71539.png)
...
![Vertical view showing the spacing variation in proportional numbers versus monospacing of tabular numbers.](assets/asset-025-proportional-numbers-monospaced-tabular-numbers-7eb1566567.png)

*Proportional numbers; Monospaced tabular numbers*

![Times displayed in tabular numbers.](assets/asset-026-use-tabular-numbers-to-prevent-layout-shifting-when-b3d5cc168f.png)
...
![Contrast between two colors, quantified by a contrast ratio, supports visual accessibility.](assets/asset-027-label-styles-should-enable-quick-reading-at-small-cfce614658.png)
...
![Large text should achieve a contrast ratio of 3:1.](assets/asset-028-large-text-should-achieve-a-contrast-ratio-of-ab4ec4271d.png)

*Large text should achieve a contrast ratio of 3:1*

![Small text should achieve a contrast ratio of 4.5:1.](assets/asset-029-small-text-should-achieve-a-contrast-ratio-of-c4e5528dba.png)
...
![Diagram showing the default color for text is "on surface."](assets/asset-030-default-typography-colors-86b3b6f756.png)
...
![In a paragraph, md.sys.color.primary color is applied to an underlined hyperlink.](assets/asset-031-hyperlinks-should-be-underlined-and-use-primary-or-46d52afbf9.png)
