...
![FAB with highly contrasting bright container and dark icon.](assets/asset-001-do-fab-icons-are-above-the-3-1-07bdea7215.png)

*Do FAB icons are above the 3:1 contrast ratio*

![FAB with low-contrasting dark container and dark icon.](assets/asset-002-don-t-avoid-using-colors-with-a-contrast-ca7295e707.png)
...
![A focused FAB with a tooltip saying “Compose” appearing below it.](assets/asset-003-tooltips-surface-the-fab-s-label-when-focused-6444a6a741.png)
...
![FAB in the lower right region of a small screen.](assets/asset-004-in-compact-windows-place-the-fab-in-the-7c27431e0e.png)

*In compact windows, place the FAB in the bottom trailing edge*

![FAB in the upper left region of a large screen.](assets/asset-005-in-expanded-windows-place-the-fab-in-the-cc18fc6ddd.png)
...
![FAB in the lower right region doesn’t obscure the focus indicator of an actionable icon.](assets/asset-006-do-the-fab-can-partially-cover-an-actionable-c286b937ac.png)

*Do The FAB can partially cover an actionable element, as long as the focus indicator is still clearly visible*

![FAB in the lower right region obscures an actionable icon and its focus indicator.](assets/asset-007-don-t-completely-obscure-an-actionable-element-and-0c9c0611a5.png)
...
![Accessibility label and accessibility role of a FAB.](assets/asset-008-the-accessibility-label-of-the-fab-with-a-c440e169a7.png)
