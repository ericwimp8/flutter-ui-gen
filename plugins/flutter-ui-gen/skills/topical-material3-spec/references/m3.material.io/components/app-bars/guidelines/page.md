...
![4 app bars with headlines and action icons.](assets/asset-001-app-bars-show-information-about-the-page-key-d2bc95c851.png)
...
![App bar with navigation icon buttons and a 2-line title.](assets/asset-002-app-bars-provide-content-and-actions-related-to-85fe4c2168.png)
...
![App bar with content below.](assets/asset-003-app-bars-can-display-one-high-visibility-action-8549701215.png)
...
![App bar with 1 filled button.](assets/asset-004-do-use-a-filled-or-tonal-button-for-5dc32a5416.png)

*Do Use a filled or tonal button for important actions*

![App bar with 2 filled buttons, side by side.](assets/asset-005-don-t-put-multiple-filled-or-tonal-buttons-0e29e4235b.png)
...
![The 4 app bar variants.](assets/asset-006-search-app-bar-small-medium-flexible-large-flexible-5ed3cd31cd.png)
...
![2 baseline app bars.](assets/asset-007-medium-large-6cf2f79622.png)
...
![A search bar within an app bar.](assets/asset-008-search-app-bars-have-a-search-field-instead-1b2e5f84df.png)
...
![3 examples of search text in an app bar.](assets/asset-009-use-proper-capitalization-depending-on-what-s-being-527a19192e.png)
...
![2 icons placed in the search bar.](assets/asset-010-put-the-most-used-actions-on-the-left-ca661387b6.png)
...
![A search app bar with a logo, search bar, and avatar.](assets/asset-011-the-leading-element-can-be-a-product-logo-2165b619b1.png)
...
![3 icons placed in a search app bar.](assets/asset-012-don-t-use-three-icons-and-an-avatar-4dce730a08.png)
...
![4 actions placed in a search app bar on a large screen.](assets/asset-013-increased-horizontal-space-on-larger-screens-allows-for-a2bd484ebe.png)
...
![App bar with a light search container color.](assets/asset-014-search-app-bars-can-use-different-colors-like-de0ec1c33f.png)

*Search app bars can use different colors, like surface bright, for improved contrast with surrounding elements*

## Anatomy

![Diagram of app bar layout.](assets/asset-015-container-headline-trailing-icons-subtitle-leading-button-fb5d4efdb7.png)
...
![App bar with square corners.](assets/asset-016-do-use-straight-corners-for-app-bars-b4c3e19602.png)

*Do Use straight corners for app bars*

![App bar with curved corners.](assets/asset-017-don-t-use-curved-shapes-this-implies-that-c796d39a1a.png)
...
![App bar at default height.](assets/asset-018-do-default-heights-were-chosen-to-ensure-readability-e0d8b759ad.png)

*Do Default heights were chosen to ensure readability of on-screen elements*

![App bar with reduced height.](assets/asset-019-don-t-don-t-make-an-app-bar-54a31faadc.png)
...
![A logo added to an app bar.](assets/asset-020-image-logos-can-replace-all-text-in-small-2f67172b47.png)
...
![Leading navigation icon aligned on left of app bar](assets/asset-021-leading-back-button-5e11da1723.png)
...
![App bar headline text set in 2 lines.](assets/asset-022-do-if-headline-text-is-long-use-a-605e4a1fe8.png)

*Do If headline text is long, use a medium flexible or large flexible app bar and wrap the headline to two lines maximum*

![Small app bar headline text wrapped on 2 lines.](assets/asset-023-don-t-wrap-text-in-a-small-app-6547ec4fef.png)
...
![Search, small, medium and large flexible app bars with headline styles.](assets/asset-024-search-body-large-small-title-large-medium-flexible-746a8c900e.png)
...
![Small to large flexible app bars with headline and subtitle styles.](assets/asset-025-small-label-medium-medium-flexible-label-large-large-b24dfd27a6.png)
...
![2 icons placed to right of headline, from most to least used.](assets/asset-026-put-the-most-used-actions-on-the-left-9cc380db0a.png)
...
![App bar with 2 filled icons, “save” and “download.”](assets/asset-027-do-use-filled-icons-for-clear-visible-actions-468b29316f.png)

*Do Use filled icons for clear, visible actions*

![App bar with 2 outlined icons, “save” and “download.”](assets/asset-028-caution-outlined-icons-can-be-used-as-needed-24b8ed127b.png)
...
![App bar in RTL with Hebrew text.](assets/asset-032-the-app-bar-s-layout-is-mirrored-for-ac57f43248.png)
