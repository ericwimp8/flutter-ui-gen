...
Source: https://m3.material.io/components/split-button/overview

- Use to show an action with a menu of related actions
- Same size range as buttons and icon buttons: XS, S, M, L, XL

[Video: An extra large split button. It has a label and icon on one part of the button, and a menu icon on the other part.](assets/asset-001-split-buttons-are-made-of-a-common-button-eaf3e639b9.webp)
...
| Implementation | [MDC-Android: Expressive](https://github.com/material-components/material-components-android/blob/master/docs/components/Button.md#split-button) | Available |
