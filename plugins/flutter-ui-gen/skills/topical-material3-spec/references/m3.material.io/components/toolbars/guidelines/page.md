...
![5 toolbars of various colors, elements, and actions.](assets/asset-001-toolbars-can-be-used-for-a-wide-variety-326f02b944.png)
...
![Vibrant toolbar at bottom of mobile screen.](assets/asset-002-a-toolbar-provides-actions-related-to-the-current-e43f483167.png)
...
![Docked toolbar example.](assets/asset-003-docked-toolbar-shows-global-controls-a7e7b70351.png)

*Docked toolbar shows global controls*

![Floating toolbar example.](assets/asset-004-floating-toolbar-show-controls-relevant-to-the-current-96bec9db6c.png)
...
![Toolbar showing local navigation.](assets/asset-005-toolbar-actions-can-open-a-menu-f04bf979eb.png)
...
![Toolbar with low-emphasis controls.](assets/asset-006-use-the-standard-color-scheme-to-draw-focus-e9c0a39e4e.png)

*Use the standard color scheme to draw focus to content outside the toolbar*

![Toolbar with high-emphasis controls.](assets/asset-007-use-the-vibrant-color-scheme-to-emphasize-controls-88563422b6.png)
...
![A navigation bar shown on the main email Inbox page, and a toolbar shown when reading the email.](assets/asset-008-navigation-bar-on-a-primary-page-toolbar-on-569862f50e.png)
...
![Floating toolbar with secondary navigation labels.](assets/asset-009-do-keep-navigation-distinct-and-use-a-toolbar-c7feaaeae3.png)
...
![Floating toolbar with secondary navigation labels displaying above a bottom navigation bar.](assets/asset-010-don-t-show-a-navigation-bar-and-a-281cba5593.png)

*Don’t show a navigation bar and a toolbar with navigation controls at the same time*

## Anatomy

![Diagram of toolbar layouts.](assets/asset-011-container-elements-69be9743d5.png)
...
![Docked toolbar with square corners.](assets/asset-012-do-use-straight-corners-for-docked-toolbars-ed94101f17.png)

*Do Use straight corners for docked toolbars*

![Docked toolbar with rounded corners.](assets/asset-013-don-t-avoid-modifying-the-container-shape-9dc1a4c7ea.png)
...
![Docked toolbar with too many controls.](assets/asset-014-don-t-overwhelm-people-with-too-many-controls-315bfdbe15.png)
...
![Floating toolbar with overflow menu icon.](assets/asset-015-do-choose-the-most-essential-actions-to-show-7666f89f3b.png)

*Do Choose the most essential actions to show on screen by default*

![Floating toolbar that expands off edge of screen.](assets/asset-016-don-t-floating-toolbars-shouldn-t-exceed-the-b2f3847fc6.png)
...
![Vibrant floating toolbar that's easy to see in front of a neutral text background.](assets/asset-017-the-elevation-on-floating-toolbars-can-be-removed-36489bc358.png)
...
![5 toolbars with slots, and various combinations of buttons, icon buttons, filled icon buttons, and text fields.](assets/asset-018-toolbars-are-made-of-slots-that-can-contain-e3475a9eae.png)
...
![2 floating toolbars, 1 with a filled action button and 1 paired with a FAB.](assets/asset-019-two-different-ways-to-create-a-high-emphasis-f120deb3ee.png)

*Two different ways to create a high emphasis action in toolbars*

![Floating toolbar with primary action and FAB.](assets/asset-020-don-t-emphasize-multiple-buttons-with-bold-primary-d6a79adb08.png)
...
![Floating toolbar with different control designs.](assets/asset-021-don-t-avoid-mixing-too-many-different-controls-a893184518.png)
...
![A floating toolbar, which is rounded, with squared icon buttons inside.](assets/asset-022-don-t-use-square-filled-icon-buttons-in-03f5d800dd.png)
...
![3 toolbars paired with FABs.](assets/asset-023-floating-toolbars-can-be-paired-with-fabs-7d61732038.png)
...
![Docked toolbar on mobile.](assets/asset-024-docked-toolbars-are-always-at-the-bottom-of-5e50cc5bee.png)
...
![Floating toolbar on mobile.](assets/asset-025-horizontal-floating-toolbars-should-be-at-least-16dp-e15db6ffe4.png)
...
![Vertical floating toolbar with 24dp margin.](assets/asset-026-maintain-at-least-a-24dp-margin-for-vertical-d858f7abf1.png)
...
![Toolbar showing local navigation.](assets/asset-027-don-t-using-wide-buttons-with-vertical-toolbars-aaf76f3b86.png)
...
![Large screen UI showing both a navigation rail and vertical floating toolbar.](assets/asset-028-when-a-nav-rail-is-visible-the-floating-da927328ac.png)
...
![Docked toolbar with evenly spaced elements.](assets/asset-029-docked-toolbar-items-should-be-evenly-spaced-in-3716397219.png)

*Docked toolbar items should be evenly spaced in compact windows*

![Docked toolbar with centered elements.](assets/asset-030-in-medium-window-sizes-and-larger-create-a-eca605f850.png)

*In medium window sizes and larger, create a spacious layout by centering all elements*

![Docked toolbar with central action and some elements pushed to the edge.](assets/asset-031-align-controls-to-the-edge-of-the-screen-45646b881c.png)
...
![Docked toolbar with 15 actions for text editing on large screens, organized with dividers.](assets/asset-032-on-web-and-other-large-screens-docked-toolbars-c5ccc98f26.png)
...
![Floating toolbar in compact window with excess padding.](assets/asset-033-don-t-add-extra-space-to-a-toolbar-b37af2c99b.png)

*Don’t add extra space to a toolbar beyond its necessary items*

![Floating toolbar in expanded window class.](assets/asset-034-at-larger-screen-sizes-the-container-can-display-ed2c20be13.png)
...
![Vertical toolbar in a compact window.](assets/asset-035-caution-vertical-toolbars-can-cover-important-content-in-c3031bb4d5.png)
...
![2 toolbars, each with distinct stylistic treatment and actions.](assets/asset-036-multiple-toolbars-with-different-stylistic-treatments-can-create-950f5e34cf.png)
...
![Multiple toolbars in a compact window.](assets/asset-037-don-t-avoid-using-multiple-toolbars-in-smaller-f583368380.png)
...
![Next button is on trailing edge for a LTR language.](assets/asset-039-in-ltr-languages-the-next-button-is-intentionally-9032eac5a0.png)

*In LTR languages, the Next button is intentionally placed on the trailing (right) edge*

![Next button is now on the trailing edge, at left, for RTL language.](assets/asset-040-in-rtl-languages-reverse-the-order-so-next-fafa74d36c.png)
