...
![FAB menu measurement annotations. All elements are larger than the minimum target size.](assets/asset-001-fab-menus-have-48x48dp-minimum-width-and-sufficient-5c216e2875.webp)
...
![FAB menu items are scrolling behind the close button.](assets/asset-002-do-allow-the-menu-items-to-scroll-behind-1a9f43852e.webp)

*Do Allow the menu items to scroll behind the close button*

![FAB menu items are scrolling in front of the close button.](assets/asset-003-don-t-obstruct-the-close-button-in-short-66814ec95e.webp)
...
![4 FAB menus with the focus order labelled. Focus moves from the close button at the bottom to the topmost menu item next.](assets/asset-004-close-button-first-menu-item-second-menu-item-2ead33bfe7.webp)
...
![Accessibility labels for the close button on an Android device.](assets/asset-005-on-android-the-close-button-accessibility-labels-should-9cb339eee8.webp)
...
![Accessibility labels for a FAB menu item on an Android device.](assets/asset-006-label-fab-menu-items-to-match-their-ui-9239226faf.webp)
