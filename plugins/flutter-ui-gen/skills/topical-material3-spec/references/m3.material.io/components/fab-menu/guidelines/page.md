...
![On a page of music albums, a FAB menu shows options to make a new playlist, collection, or station.](assets/asset-001-use-the-fab-menu-to-show-multiple-related-c51e438806.png)
...
![1 mobile screen with a FAB, 1 with a FAB menu. Both are right aligned.](assets/asset-002-the-fab-menu-should-always-open-from-a-cd57a6d758.png)
...
![1 mobile screen with a FAB, 1 with a FAB menu. Both are left aligned and mirrored for a right-to-left language.](assets/asset-003-in-rtl-languages-the-fab-menu-should-be-ee28432e7d.png)
...
![A FAB menu with 5 options on a photo gallery UI.](assets/asset-004-do-fab-menus-can-have-2-6-items-30b464722a.png)

*Do FAB menus can have 2-6 items*

![A FAB menu with 1 option on a photo gallery UI.](assets/asset-005-don-t-use-a-fab-menu-with-one-7facfdb76d.png)
...
![A toolbar with a FAB directly next to it.](assets/asset-006-do-fabs-can-be-placed-next-to-toolbars-7f4e837ada.png)

*Do FABs can be placed next to toolbars*

![A toolbar with a FAB menu next to it.](assets/asset-007-don-t-add-a-fab-menu-to-a-047f1aabb2.png)
...
![A FAB menu using the primary color set.](assets/asset-008-a-primary-fab-is-paired-with-a-primary-ba8f76df03.png)
...
![A FAB menu using the secondary color set.](assets/asset-009-a-secondary-fab-is-paired-with-a-secondary-991c294170.png)
...
![A FAB menu using the tertiary color set.](assets/asset-010-a-tertiary-fab-is-paired-with-a-tertiary-15168c9556.png)

*A tertiary FAB is paired with a tertiary FAB menu*

## Anatomy

![2 elements of a FAB menu.](assets/asset-011-close-button-list-item-978ee8c2b4.png)
...
![A FAB menu with 3 options for selecting Food, People, or Nature. There are no icons next to the text.](assets/asset-012-caution-only-remove-the-icon-if-necessary-the-91e4201b2e.png)

*Caution Only remove the icon if necessary. The icon provides a differentiation between items.*

![A FAB menu with 3 options for selecting Food, People, or Nature. The options are only icons, no text.](assets/asset-013-don-t-remove-the-label-e4cbbd8efd.png)
...
![A FAB menu used out of the box with no configurations.](assets/asset-014-do-keep-the-padding-between-the-container-and-2064033843.png)

*Do Keep the padding between the container and icon, icon and text, and text and container consistent*

![FAB menu items are equal width despite having different lengths of text.](assets/asset-015-don-t-expand-container-sizes-1199059202.png)

*Don’t expand container sizes*

![FAB menu items are square instead of round.](assets/asset-016-don-t-change-fab-menu-shapes-ed438cee2f.png)
...
![A FAB menu with 24dp margins from the edge of the window.](assets/asset-018-on-desktop-use-larger-fabs-and-margins-397a09f52d.png)
...
![A FAB menu using menu component on web and traditional FAB menu on compact screen.](assets/asset-019-the-same-fab-menu-options-on-both-large-57181daa2d.png)
...
![FAB menu doesn’t obscure actionable element and its focus indicator.](assets/asset-021-do-ensure-the-actionable-element-and-its-focus-ff96f691ea.png)

*Do Ensure the actionable element and its focus indicator are visible behind the FAB menu*

![FAB menu obscures both an actionable element and its focus indicator.](assets/asset-022-don-t-block-an-actionable-element-and-its-74dfdb5088.png)
