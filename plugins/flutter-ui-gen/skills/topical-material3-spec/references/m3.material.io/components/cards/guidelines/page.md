...
Buttons Cards can include buttons (Buttons let people take action and make choices with one tap. [More on buttons](https://m3.material.io/m3/pages/common-buttons/overview)) for actions such as Learn more or Add to cart.

Icon buttons Cards can include icon buttons (Icon buttons help people take minor actions with one tap. [More on icon buttons](https://m3.material.io/m3/pages/icon-buttons/overview)) for actions such as Save, Heart, or Leave a 4-star review.

Selection controls Cards can also include chips (Chips help people enter information, make selections, filter content, or trigger actions. [More on chips](https://m3.material.io/m3/pages/chips/overview)), sliders (Sliders let users make selections from a range of values. [More on sliders](https://m3.material.io/m3/pages/sliders/overview)), checkboxes (Checkboxes let users select one or more items from a list, or turn an item on or off. [More on checkboxes](https://m3.material.io/m3/pages/checkbox/overview)), and other selection controls.
...
Multiple cards can be grouped together into collections displayed in a grid, list (Lists are continuous, vertical indexes of text and images. [More on lists](https://m3.material.io/m3/pages/lists/overview)), or carousel (Carousels show a collection of items that can be scrolled on and off the screen. [More on carousels](https://m3.material.io/m3/pages/carousel/overview)).
...
[Video: A set of 4 cards in a grid.](assets/asset-029-cards-displayed-in-a-grid-401521c690.webp)
...
[Video: 3 cards in vertical list.](assets/asset-032-cards-can-be-shown-in-a-vertical-list-e6d2d0ad9f.webp)

*Cards can be shown in a vertical list*

### Carousel

Cards can be displayed together in a horizontal row or carousel (Carousels show a collection of items that can be scrolled on and off the screen. [More on carousels](https://m3.material.io/m3/pages/carousel/overview)).

[Video: 3 event reservation cards in a horizontal row.](assets/asset-033-cards-displayed-together-in-a-horizontal-row-or-3d3093f189.webp)
...
In mobile layouts, components such as lists (Lists are continuous, vertical indexes of text and images. [More on lists](https://m3.material.io/m3/pages/lists/overview)) or cards are stretched to fit the full width of the screen without compromising visual quality or user experience. When designing for large screens with an expanded window size (Window widths 840dp to 1199dp, such as a tablet or foldable in landscape orientation, or desktop. [More on expanded window size class](https://m3.material.io/m3/pages/applying-layout/expanded)), use multiple columns to display content.
...
On smaller screens with the compact window size (Window widths smaller than 600dp, such as a phone in portrait orientation. [More on compact window size class](https://m3.material.io/m3/pages/applying-layout/compact)), consider swapping cards for lists (Lists are continuous, vertical indexes of text and images. [More on lists](https://m3.material.io/m3/pages/lists/overview)), which can display images and text in a more compact form.

Make sure that controls, actions, and other component-specific elements are maintained.

[Video: Cards on a large screen adapt to a list on a small mobile screen.](assets/asset-039-certain-devices-or-user-contexts-require-different-components-0650264e26.webp)
...
[Video: An album card expands to fill the screen and shows additional related content.](assets/asset-040-a-card-expands-to-fill-the-full-screen-907674f9e1.webp)

*A card expands to fill the full screen using a parent-child transition*

[Video: A card expands, showing all content at once.](assets/asset-041-do-expand-a-card-to-reveal-information-7b4f836be2.webp)

*Do Expand a card to reveal information*

[Video: A card expands, internally scrolling to only show some information.](assets/asset-042-don-t-scroll-within-a-card-to-reveal-2f918ac61a.webp)
...
[Video: Card interaction transitioning to full screen.](assets/asset-043-cards-can-use-a-forward-and-backward-transition-9ad8838dbb.webp)
...
A swipe gesture (Gestures are all the ways people interact with UI elements using touch. [More on gestures](https://m3.material.io/m3/pages/gestures)) can be performed on a single card at a time, anywhere on that card.

It can be used to:

- Dismiss a card
- Change the state (States show the interaction status of a component or UI element. [More on states](https://m3.material.io/m3/pages/interaction-states/overview)) of a card, such as flagging or archiving it

[Video: A card with 1 assigned swipe: to heart the entire card.](assets/asset-044-do-a-card-should-only-have-one-swipe-ad2feca126.webp)

*Do A card should only have one swipe action assigned to it*

[Video: A card with an image carousel and a swipe motion to heart only the bottom text on the card.](assets/asset-045-don-t-cards-shouldn-t-contain-content-that-f97bab6e18.webp)
...
The pick-up-and-move gesture (Gestures are all the ways people interact with UI elements using touch. [More on gestures](https://m3.material.io/m3/pages/gestures)) allows users to move and reorder cards in a collection.

[Video: A card is elevated above all other cards when moved.](assets/asset-046-do-when-moving-a-card-increase-its-elevation-e05759ea00.webp)

*Do When moving a card, increase its elevation*

[Video: A moved card bumps other cards around, and isn’t elevated above them.](assets/asset-047-don-t-let-cards-bump-other-elements-out-4851651729.webp)
...
[Video: Scrolling a page with an expanded card.](assets/asset-048-do-on-a-mobile-device-cards-can-expand-747dba60ec.webp)

*Do On a mobile device, cards can expand to reveal more content, scrolling within the screen. Content within cards doesn’t scroll.*

[Video: Expanded card on mobile with internal scrolling.](assets/asset-049-don-t-on-a-mobile-device-cards-can-cd81da8d78.webp)

*Don’t On a mobile device, cards can't internally scroll, as it could cause two scroll bars to be displayed*

#### Scrolling on desktop

On a desktop device, card content can expand and scroll within a card.

[Video: Expanded card on desktop with internal scrolling.](assets/asset-050-on-a-desktop-content-can-expand-and-scroll-f94c9ae258.webp)
