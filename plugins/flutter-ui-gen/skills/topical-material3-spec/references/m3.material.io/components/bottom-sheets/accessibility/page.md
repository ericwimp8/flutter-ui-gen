...
![Touch target area of a bottom sheet.](assets/asset-001-to-ensure-touch-target-accessibility-the-top-portion-e66a895b9b.png)
...
![Focus on the drag handle of a bottom sheet.](assets/asset-002-visible-focus-shown-on-the-drag-handle-affordance-a8a5769407.png)
...
![Bottom sheet with focused drag handle at lower preset height.](assets/asset-003-interacting-with-the-drag-handle-can-quickly-move-3471d3a87a.png)

*Interacting with the drag handle can quickly move a bottom sheet through preset heights*

![Bottom sheet with drag handle at higher preset height.](assets/asset-004-a-bottom-sheet-can-automatically-resize-to-another-6fbc98a575.png)
...
![Labeled drag handle with role of button.](assets/asset-005-label-the-drag-handle-c794d30fc9.png)
