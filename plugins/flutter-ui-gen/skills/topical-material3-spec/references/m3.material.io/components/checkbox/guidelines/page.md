...
![A list of burger additions represented with checkboxes.](assets/asset-001-checkboxes-in-a-list-of-items-4df487771b.png)
...
![List of 80's songs indicating choice through checkbox selection.](assets/asset-002-checkboxes-select-multiple-related-options-f5f8f69e19.png)
...
![List indicating choice with checkbox selection.](assets/asset-003-do-checkboxes-let-users-select-one-or-more-bae10e91f6.png)
...
![A list with multiple switches selected.](assets/asset-004-don-t-if-a-list-consists-of-multiple-eba6f0af55.png)
...
![Diagram of 2 radio buttons, one selected and one unselected.](assets/asset-005-radio-buttons-2cfb2438da.png)

*Radio buttons*

![Diagram of 2 switches, one selected and one unselected.](assets/asset-006-switches-a60f234f76.png)

*Switches*

## Anatomy

![Diagram of checkbox indicating the 2 parts of its anatomy.](assets/asset-007-1-container-2-icon-df51596430.png)
...
![Desktop screen showing music albums and a side sheet containing checkboxes for filtering music genres.](assets/asset-008-a-side-sheet-can-group-related-controls-on-c798386f81.png)
