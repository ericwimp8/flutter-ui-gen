...
![Diagram of checkbox indicating the 2 parts of its anatomy.](assets/asset-001-container-icon-6c0d638acb.webp)
...
![Checkbox color roles in light and dark themes.](assets/asset-002-checkbox-state-layer-icon-3e5349e3c6.webp)
...
![Checkboxes with text labels. The text color is the same for checked and unchecked checkboxes.](assets/asset-003-the-text-color-remains-the-same-regardless-if-d7b9e6b453.webp)
...
![Side by side view of states in light and dark themes.](assets/asset-004-enabled-disabled-hovered-focused-pressed-e2a39fbfce.webp)

*Enabled; Disabled; Hovered; Focused; Pressed*

## Measurements

![Diagram of a selected checkbox with a container width and height of 18dp and a state-layer width and height of 40dp.](assets/asset-005-diagram-of-a-selected-checkbox-with-a-container-a21996c095.webp)
