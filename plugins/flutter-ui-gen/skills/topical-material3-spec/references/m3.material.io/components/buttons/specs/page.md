...
![Diagram comparing buttons with toggle buttons.](assets/asset-001-default-button-toggle-button-15c459fb71.png)
...
![Diagram showing configurations of buttons.](assets/asset-002-size-shape-color-small-button-padding-75dca5229d.png)
...
![Diagram labeling 3 parts of a button.](assets/asset-003-container-label-text-icon-optional-4e62a9e3c9.png)
...
![Diagram shows dark and light color schemes for buttons.](assets/asset-004-default-toggle-unselected-toggle-selected-8c2090394d.png)
...
![Elevated button states.](assets/asset-005-enabled-disabled-hovered-focused-pressed-620e1b61f7.png)

*Enabled; Disabled; Hovered; Focused; Pressed*

#### Toggle

![Toggle elevated button states.](assets/asset-006-enabled-disabled-hovered-focused-pressed-df1ccd1a9c.png)
...
![Filled button states.](assets/asset-007-enabled-disabled-hovered-focused-pressed-99cef47302.png)

*Enabled; Disabled; Hovered; Focused; Pressed*

#### Toggle

![Toggle filled button states.](assets/asset-008-enabled-disabled-hovered-focused-pressed-cc039b3699.png)
...
![Tonal button states.](assets/asset-009-enabled-disabled-hovered-focused-pressed-290de5a181.png)

*Enabled; Disabled; Hovered; Focused; Pressed*

#### Toggle

![Toggle tonal button states.](assets/asset-010-enabled-disabled-hovered-focused-pressed-2532077c00.png)
...
![Outlined button states.](assets/asset-011-enabled-disabled-hovered-focused-pressed-01ea7ddcaf.png)

*Enabled; Disabled; Hovered; Focused; Pressed*

#### Toggle

![Outlined button states.](assets/asset-012-enabled-disabled-hovered-focused-pressed-9b827233bb.png)
...
![Default text button style states.](assets/asset-013-enabled-disabled-hovered-focused-pressed-b08aa1bcbc.png)
...
![Shape changes of a button.](assets/asset-014-enabled-hovered-pressed-68b44baebd.png)
...
![Shape changes of a toggle button.](assets/asset-015-enabled-hovered-pressed-selected-e44e2cb8aa.png)

*Enabled; Hovered; Pressed; Selected*

## Measurements

![Diagram of measurements of all button sizes.](assets/asset-016-extra-small-small-medium-large-extra-large-a58ea29405.png)
...
![Diagram of small button target areas.](assets/asset-017-round-button-button-with-icon-square-button-9367ffff6a.png)

*Round button; Button with icon; Square button*

### Corner sizes

![Diagram of corner radii of buttons.](assets/asset-018-diagram-of-corner-radii-of-buttons-2eaa5dc99e.png)
