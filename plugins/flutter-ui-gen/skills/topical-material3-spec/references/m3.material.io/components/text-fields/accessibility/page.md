...
![Filled text field in enabled (empty) state and in focused (populated state) have visual cues to identify their state.](assets/asset-001-filled-text-fields-c17744445c.png)

*Filled text fields*

![Outlined text field in enabled (empty) state and in focused (populated state) have visual cues to identify their state.](assets/asset-002-outlined-text-fields-f756afee0d.png)
...
![An outlined text field with label text that passes the minimum contrast of 3:1.](assets/asset-003-do-make-sure-the-container-outline-has-a-aec0a2d6a3.png)

*Do Make sure the container outline has a minimum contrast of 3:1 to the background*

![An outlined text field with label text fails the minimum 3:1 contrast.](assets/asset-004-don-t-don-t-choose-colors-that-won-d3224dd839.png)
...
![The text field and accessibility label both read “Email.” The role is “textbox.”](assets/asset-005-a-text-field-s-label-should-include-its-019ccd1cae.png)
...
![The trailing icon’s accessibility label “Show Password.” The role is “Button.”](assets/asset-006-when-a-trailing-icon-in-the-field-acts-26ed808449.png)
...
![Text field accessibility labels “UI text” are “Euro” for a currency prefix and “At gmail dot com” for the email address suffix.](assets/asset-007-a-form-containing-fields-with-both-a-prefix-94674e4bc1.png)
...
![The text field accessibility labels is: UI text “Not a valid ZIP code.” The role is “Alert.”](assets/asset-008-text-field-error-messages-should-be-given-an-fffd847ebf.png)
...
![A character counter's accessibility label reads: UI text (“Character count, 5/20”)](assets/asset-009-the-remaining-character-counter-should-be-called-character-5a7d26d279.png)
...
![The accessibility label uses the supporting text. It reads: UI text (“Please use the company email address”). Role \[No role\].](assets/asset-010-text-field-supporting-text-should-have-its-own-b5d08cc610.png)
...
![Accessibility label reads: UI text (“Username*”). The role is “Textbox.”](assets/asset-011-a-required-text-field-s-accessibility-label-should-d42a23f062.png)
