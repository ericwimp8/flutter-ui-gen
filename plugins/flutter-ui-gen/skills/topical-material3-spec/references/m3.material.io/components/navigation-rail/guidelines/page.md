...
![Colorful, purple navigation rail shown collapsed and expanded.](assets/asset-001-use-the-menu-icon-to-transition-between-collapsed-e80791b26d.png)
...
![Collapsed navigation rail with “timer” icon on FAB.](assets/asset-002-a-navigation-rail-should-be-the-only-visible-582f60bc7c.png)
...
![Expanded navigation rail shown expanded by default and expanded over screen content.](assets/asset-003-a-navigation-rail-can-be-expanded-by-default-dd6eef2849.png)
...
![Navigation rail and hidden navigation rail with menu icon button for expansion.](assets/asset-004-the-expanded-navigation-rail-can-also-be-hidden-666834168b.png)

*The expanded navigation rail can also be hidden, appearing only when the menu icon is selected*

## Anatomy

![10 elements of expanded and collapsed navigation rails.](assets/asset-005-container-menu-optional-floating-action-button-fab-optional-f01878714b.png)
...
![Right-to-left navigation rail in Hebrew, and left-to-right navigation rail in English.](assets/asset-006-the-navigation-rail-should-be-placed-on-the-a707b7084f.png)
...
![Horizontal navigation rail on timer screen.](assets/asset-007-don-t-use-the-navigation-rail-horizontally-use-7c16051167.png)
...
![Navigation rails with different alignments.](assets/asset-008-top-and-center-aligned-rail-destination-placement-ff3567149a.png)
...
![Expanded and collapsed navigation rails controlled by a menu icon button.](assets/asset-009-a-navigation-rail-can-expand-to-reveal-more-5f880bc29d.png)
...
![Navigation rail with a FAB button at the top of the screen.](assets/asset-010-do-a-top-aligned-fab-in-the-navigation-2d5654c314.png)

*Do A top-aligned FAB in the navigation rail*

![Navigation rail with a FAB button at the bottom of the screen.](assets/asset-011-don-t-avoid-placing-the-fab-below-navigation-66c75510bd.png)
...
![Navigation rail with Material design logo at the top of the screen.](assets/asset-012-caution-use-caution-when-placing-logos-in-the-102c3bb919.png)
...
![Navigation rail with active indicators present for the current screen.](assets/asset-013-do-use-the-active-indicator-only-for-the-e646bea829.png)

*Do Use the active indicator only for the current open page*

![Navigation rail with active indicators present for all navigation items.](assets/asset-014-don-t-use-the-active-indicator-for-more-56e9bd666b.png)
...
![Navigation rail with active indicator that hugs the text and icon.](assets/asset-015-the-active-indicator-hugs-contents-in-the-expanded-4c7ff7c606.png)

*The active indicator hugs contents in the expanded nav rail*

![Navigation rail with active indicator that is larger than the content within it.](assets/asset-016-override-the-indicator-to-fill-the-container-to-b005ce5517.png)
...
![Navigation rail with icons that fit the destinations, like a timer icon and label leading to a timer feature.](assets/asset-017-icons-should-symbolize-the-content-of-the-page-1acbe99139.png)
...
![Icons with and without an active indicator.](assets/asset-018-selected-navigation-items-have-an-active-indicator-a-0d19167adb.png)
...
![Navigation rail with clear text labels.](assets/asset-019-do-write-clear-and-concise-labels-that-describe-4baac85247.png)
...
![Navigation rail with lengthy text labels.](assets/asset-020-caution-break-up-longer-phrases-into-two-text-df9d238855.png)
...
![Navigation rail with truncated text label with ellipses.](assets/asset-021-don-t-truncate-or-display-an-ellipsis-in-70ddb1a111.png)

*Don’t truncate or display an ellipsis in place of label text*

![Navigation rail with small text label.](assets/asset-022-don-t-reduce-the-type-size-to-fit-ff1fca6b00.png)
...
![Navigation rail with badges on each icon.](assets/asset-023-1-small-badge-on-a-rail-destination-2-acbf3a6016.png)
...
![Navigation rail with divider separating it from screen content.](assets/asset-024-a-divider-can-make-the-navigation-rail-container-206d31762b.png)
...
![Navigation bar on a phone screen and navigation rail on a tablet screen.](assets/asset-025-on-smaller-devices-use-a-navigation-bar-on-1c00d6f214.png)
