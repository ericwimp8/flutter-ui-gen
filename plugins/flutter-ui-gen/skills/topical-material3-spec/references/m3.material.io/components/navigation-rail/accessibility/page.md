...
![Colorful, purple navigation rail shown collapsed and expanded.](assets/asset-001-touch-tap-c3f7d979fc.webp)

*Touch: Tap*

![Tap indicator on a collapsed nav rail.](assets/asset-002-cursor-hover-click-128ac7e09c.webp)
...
![Touch indicator on a nav rail.](assets/asset-003-touch-tap-7f54e0dd7e.webp)
...
![Navigation rail with filled element.](assets/asset-004-do-use-the-default-color-scheme-to-ensure-5e9239550c.webp)

*Do Use the default color scheme to ensure proper contrast and emphasis on the active destination*

![Nav rail with multiple navigation destinations and multi-colored contrast.](assets/asset-005-don-t-use-more-than-two-colors-for-86b06fb581.webp)
...
![Icon button with semibold weight, without filled options.](assets/asset-006-an-icon-with-no-filled-option-should-use-0bcead9832.webp)
...
![Nav rail with text scaled to 1.5x size. All labels are on one line.](assets/asset-007-text-scaled-to-1-5-size-84a7846cd0.webp)

*Text scaled to 1.5 size*

![Nav rail with text scaled to 2x size. Some labels wrap to two lines.](assets/asset-008-text-scaled-to-2x-size-874f5356df.webp)
...
![Arrows help people move between pages.](assets/asset-009-use-arrows-to-move-between-navigation-items-0e0476725c.webp)

*Use arrows to move between navigation items*

![Space/enter help people choose a navigation destination.](assets/asset-010-use-space-enter-to-activate-the-focused-navigation-77016bc826.webp)
...
![Nav bar with an active, filled icon button.](assets/asset-011-do-use-a-filled-icon-variant-on-the-9c231eca99.webp)

*Do Use a filled icon variant on the selected navigation item to differentiate from inactive navigation items*

![Selected navigation item without filled icon style.](assets/asset-012-don-t-avoid-using-the-same-unfilled-icon-0adaaba625.webp)
...
![“Maps” is both the icon label text and the accessibility label.](assets/asset-013-while-the-visible-label-text-reads-recent-the-b9db88a706.webp)
