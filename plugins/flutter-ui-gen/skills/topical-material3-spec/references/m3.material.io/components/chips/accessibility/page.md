...
[Video: Selecting a leading button pushes chips previously reachable only by scroll below, making them all visible.](assets/asset-002-the-show-all-filter-chip-is-used-to-0fbcdbef18.webp)
...
[Video: Selecting a filter button produces a menu with all previously hidden chips visible.](assets/asset-003-the-show-all-leading-button-shows-a-menu-2d8d71bdc7.webp)
