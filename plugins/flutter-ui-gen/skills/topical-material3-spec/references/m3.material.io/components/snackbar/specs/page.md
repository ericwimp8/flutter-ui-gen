...
![Diagram of snackbar indicating the four parts of its anatomy](assets/asset-001-container-icon-optional-close-affordance-action-optional-supporting-b2cffd1874.webp)
...
![Diagram of snackbar indicating color and inverse text and labels](assets/asset-002-inverse-surface-inverse-on-surface-inverse-primary-inverse-a31567d16e.webp)

*Inverse surface; Inverse on surface; Inverse primary; Inverse on surface*

## Measurements

![Diagram of snackbar with action](assets/asset-003-snackbar-padding-and-size-measurements-9b2cde1578.webp)

*Snackbar padding and size measurements*

## Configurations

![5 snackbar configurations.](assets/asset-004-single-line-single-line-with-action-two-lines-3f36626c34.webp)
