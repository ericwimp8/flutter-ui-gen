...
[Video: Taking a menu item action moves focus to a snackbar. Moving focus out of the snackbar returns it to the same menu item.](assets/asset-004-focus-returns-from-the-snackbar-1-to-the-0f09f41bb1.webp)
...
[Video: Confirming in a dialog moves focus to a snackbar. Moving focus out of the snackbar returns it to a page element.](assets/asset-005-if-the-previously-focused-element-is-no-longer-0ed9c3ad31.webp)
