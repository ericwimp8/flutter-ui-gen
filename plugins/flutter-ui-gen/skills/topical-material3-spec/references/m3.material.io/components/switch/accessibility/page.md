...
![The switch handle increases in size when tapped and dragged.](assets/asset-001-touch-tap-drag-37cd15057c.png)

*Touch: Tap, Drag*

![The cursor changes from an arrow to a hand pointer when hovering over and clicking the switch.](assets/asset-002-cursor-hover-click-bc1427bcd5.png)
...
![The focus is on the switch handle, which is toggled on.](assets/asset-003-focus-lands-on-the-switch-handle-d60368ea47.png)

*Focus lands on the switch handle*

![Space or Enter is used to toggle the switch off.](assets/asset-004-the-switch-is-toggled-using-space-or-enter-24f466413b.png)
...
![“Dark theme” is the switch’s adjacent label text and the accessibility label.](assets/asset-005-a-switch-s-accessibility-label-can-incorporate-its-47f5c7d7ce.png)
...
![The accessibility label for the switch is “Photo album access” though the label text is “photo album.”](assets/asset-006-while-the-visible-label-text-reads-photo-album-71ac5a944e.png)
