...
![Hinted search text and autocomplete results on a mobile screen.](assets/asset-001-autocomplete-results-should-be-announced-by-the-screen-ec8d814fd5.png)
...
![Search bar with a focused leading icon.](assets/asset-002-initial-focus-can-land-on-a-leading-icon-34578e8df5.png)

*Initial focus can land on a leading icon*

![Search bar with no leading icon. The text field is focused.](assets/asset-003-if-there-s-no-leading-icon-focus-lands-b66cd640b5.png)
...
![Search bar with “Label: Search messages” and “Role: Text field”.](assets/asset-004-the-accessibility-label-should-match-the-hinted-search-52e6dfdd88.png)
...
![A search bar with accessibility labels for its leading icon button and trailing avatar.](assets/asset-005-use-icon-labels-for-icon-buttons-abcf86d8a0.png)
...
![A search bar on mobile, showing search results in a list.](assets/asset-006-search-suggestions-and-results-are-created-using-lists-6b0e3eb24e.png)
