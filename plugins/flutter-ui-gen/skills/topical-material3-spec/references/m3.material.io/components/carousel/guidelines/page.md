...
![Carousel items adapting dynamically to device size by shrinking and reducing in number.](assets/asset-001-carousel-items-adapt-dynamically-based-on-window-size-584af5b7ae.webp)
...
![Contained carousel with a large, medium, and small item. Text is hidden on the small item.](assets/asset-002-a-carousel-can-contain-different-sized-items-f756bb92a5.webp)
...
![Multi-browse carousel with all images and text easily legible.](assets/asset-003-do-set-the-large-carousel-item-size-to-7670b21070.webp)

*Do Set the large carousel item size to ensure the images and text are easy to read and recognize*

![Multi-browse carousel with a very thin small item, making the image unrecognizable.](assets/asset-004-don-t-avoid-setting-carousel-items-so-small-58297a0562.webp)
...
![Carousel on a phone. 2 large, 1 medium, and 1 small item are fully visible but thin. The items don't have text.](assets/asset-007-caution-in-compact-windows-only-show-more-than-2e8cffd912.webp)
...
![4 elements of a carousel.](assets/asset-013-container-large-carousel-item-medium-carousel-item-small-4c2d17f445.webp)
...
![An empty rectangle representing a carousel container.](assets/asset-014-the-carousel-container-is-a-rectangle-it-can-36694c00b3.webp)
...
![3 sizes of carousel items.](assets/asset-015-large-carousel-item-medium-carousel-item-small-carousel-d597877b00.webp)
...
![2 sizes of carousel items for hero layouts.](assets/asset-016-large-item-small-item-00b89286c8.webp)
...
![3 sizes of carousel items for multi-browse layouts. 2 large items are visible.](assets/asset-017-large-item-medium-item-small-item-00d896d5c7.webp)
...
![Contained carousel items with 5 lines of content: a title, a description, and a label.](assets/asset-018-caution-avoid-exceeding-two-lines-of-text-in-900915fdb1.webp)
...
![A carousel item at 3 different sizes to show how text changes at each size.](assets/asset-019-large-carousel-item-with-the-full-title-and-aa17868a47.webp)
...
![8 carousel items visible at once on a tablet in landscape orientation.](assets/asset-020-carousels-can-show-more-items-at-once-on-8107258aff.webp)
...
![Full-screen carousel with items stopping halfway off screen once scrolled.](assets/asset-022-don-t-avoid-scrolling-freely-on-full-screen-5ec43e6798.webp)
