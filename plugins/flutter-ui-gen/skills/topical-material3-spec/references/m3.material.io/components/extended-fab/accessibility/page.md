...
![On a large screen, the Compose FAB is placed on the upper left region in an email app with the expanded window on the right.](assets/asset-001-extended-fabs-can-be-placed-in-the-expanded-89587f76b2.png)

*Extended FABs can be placed in the expanded navigation rail*

![In a compact window, the Compose FAB is placed on the lower right region in an email app.](assets/asset-002-do-place-extended-fabs-in-an-easy-to-bacead3cf0.png)

*Do Place extended FABs in an easy-to-reach place that doesn’t obstruct other actions*

![In a compact window, the Compose FAB is overlapping other buttons in an email app.](assets/asset-003-don-t-place-extended-fabs-over-another-actionable-f96aa9a88a.png)
...
![A focused extended FAB in the lower right region of a mobile screen.](assets/asset-004-do-ensure-extended-fabs-get-focus-when-navigating-be6c8f36b6.png)

*Do Ensure extended FABs get focus when navigating with assistive technology*

![A focused extended FAB with a tooltip matching the text label.](assets/asset-005-don-t-tooltips-aren-t-required-since-the-176648bc5d.png)
...
![Accessibility labels of an extended FAB.](assets/asset-006-the-accessibility-label-reads-compose-to-match-the-4eb7e74228.png)
