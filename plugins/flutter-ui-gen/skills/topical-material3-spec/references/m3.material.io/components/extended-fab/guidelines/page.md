...
![Vibrant extended FAB on an email screen.](assets/asset-001-extended-fabs-are-more-prominent-than-regular-fabs-4cd14ebce7.webp)
...
![A centered extended FAB is used to check out in a shopping app.](assets/asset-002-extended-fabs-ensure-the-main-action-is-visible-fa66e73f82.webp)

*Extended FABs ensure the main action is visible at all times*

![Extended FAB on an article with lots of body content to publish that article.](assets/asset-003-use-an-extended-fab-to-provide-constant-access-7f934f8b1f.webp)

*Use an extended FAB to provide constant access to a primary action above long-scrolling surface content*

![Extended FAB on a task list to create a new task.](assets/asset-004-use-an-extended-fab-to-emphasize-a-page-c13987409f.webp)
...
![Extended FAB labeled “find flights” with an airplane icon, which would be unclear on its own.](assets/asset-005-an-extended-fab-can-be-effective-where-an-15de5a1706.webp)
...
![An extended FAB used on a screen.](assets/asset-006-do-only-show-one-prominent-action-at-a-56c56ba5b2.webp)

*Do Only show one prominent action at a time with the extended FAB*

![2 extended FABs used on 1 screen.](assets/asset-007-don-t-use-multiple-extended-fabs-in-one-01a28feb57.webp)
...
![Filled button labeled “finish setup” next to a “back” button.](assets/asset-008-do-use-a-button-with-appropriate-styling-to-d3c1822c57.webp)

*Do Use a button with appropriate styling to emphasize it in a group of buttons*

![Extended FAB labeled “finish setup” next to a “back” button.](assets/asset-009-don-t-use-the-extended-fab-to-convey-eacc5df064.webp)
...
![1 large, 1 medium, and 1 small extended FAB on 3 different screen sizes.](assets/asset-010-there-are-three-sizes-of-extended-fabs-826ce10595.webp)

*There are three sizes of extended FABs*

## Anatomy

![3 extended FAB elements.](assets/asset-011-container-label-text-icon-optional-e4f73869e8.webp)
...
![Fixed-width extended FAB, centered, ignoring layout grid.](assets/asset-012-the-extended-fab-container-hugs-the-icon-and-4f978c4168.webp)
...
![Extended FAB without an icon, labeled “Save draft”.](assets/asset-013-do-unlike-standard-fabs-extended-fabs-don-t-597f57cd0f.webp)

*Do Unlike standard FABs, extended FABs don't require an icon*

![Extended FAB with icon only, with no label text.](assets/asset-014-don-t-an-extended-fab-can-t-have-89babed9a8.webp)
...
![Extended FAB with short text “Save”.](assets/asset-015-do-shorten-the-text-as-much-as-needed-bf9c5b417a.webp)

*Do Shorten the text as much as needed. Include an icon for additional context.*

![Extended FAB with wrapping text “Save draft in folder”.](assets/asset-016-don-t-avoid-wrapping-or-truncating-text-2d54b0e8d2.webp)

*Don’t Avoid wrapping or truncating text*

## Placement

![Extended FAB placed above navigation bar.](assets/asset-017-do-place-the-extended-fab-above-the-rest-4ef7ea2b1a.webp)

*Do Place the extended FAB above the rest of the UI, off of elements like app bars*

![Extended FAB overlaid on a docked toolbar.](assets/asset-018-don-t-place-the-extended-fab-on-top-e7d2f09311.webp)

*Don’t place the extended FAB on top of toolbars. It disrupts the consistency of the elevation and surface layers.*

![Extended FAB below an app bar at the top of a mobile screen.](assets/asset-019-don-t-place-the-extended-fab-in-the-f3e2f911ab.webp)

*Don’t place the extended FAB in the upper half of a mobile screen, as it disrupts the reading of the UI*

![An extended FAB labeled "Confirm" on a dialog to "Confirm your location".](assets/asset-020-don-t-place-extended-fabs-on-cards-or-d5d19fdb33.webp)
...
![The extended FAB is next to a floating toolbar.](assets/asset-021-don-t-floating-toolbars-can-be-paired-with-b3fb88406c.webp)
...
![Example of extended FAB transforming into standard FAB.](assets/asset-022-when-space-is-limited-an-extended-fab-can-0ee65fbe75.webp)
...
![Extended FAB in a left-to-right language placed at the bottom right of a screen. The icon is to the left of the text.](assets/asset-023-icons-should-be-placed-to-the-left-of-925fbb8043.webp)

*Icons should be placed to the left of labels for left-to-right (LTR) languages*

![Extended FAB in a right-to-left language placed at the bottom left of a screen. The icon is to the right of the text.](assets/asset-024-icons-should-be-placed-to-the-right-of-a3a266a7a8.webp)
...
![Extended FAB center-aligned on a mobile screen.](assets/asset-025-the-extended-fab-can-be-center-aligned-966f050130.webp)

*The extended FAB can be center-aligned*

![Extended FAB right-aligned on a mobile screen.](assets/asset-026-the-extended-fab-can-be-aligned-to-the-5b45dadfb3.webp)
...
![Extended FAB at bottom right of screen.](assets/asset-027-the-extended-fab-can-be-right-aligned-in-68708c58ea.webp)

*The extended FAB can be right-aligned in both LTR and RTL languages*

![Extended FAB in navigation drawer.](assets/asset-028-the-extended-fab-can-be-at-the-top-e6c5805225.webp)
