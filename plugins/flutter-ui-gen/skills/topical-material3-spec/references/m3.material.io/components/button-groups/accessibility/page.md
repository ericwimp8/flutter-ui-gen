...
![Extra small and small button groups with 48x48dp target areas annotated over top. The area is larger than the buttons.](assets/asset-001-extra-small-button-group-small-button-group-1f6ecf96a6.png)
...
![Focus order lands on the first button, then the next buttons.](assets/asset-002-initial-focus-should-land-on-the-first-button-79c564fc82.png)
...
![Button group with annotations for navigation with Tab and selecting with Space or Enter.](assets/asset-003-initial-focus-selected-button-3bdb4e210f.png)
...
![In a messaging products, an email icon is labelled “email” with the role “button”.](assets/asset-004-label-each-button-within-the-button-group-5e0454612c.png)
